...
<tr><td>Banche Dati IT</td><td>ItalgiureWeb / editori</td><td>Cassazione, Consiglio di Stato, TAR, Corte Cost.</td></tr>
</table>
...
<h2>10.4 Banche Dati Italiane</h2>
<p>Modulo che integra le principali banche dati giuridiche italiane a pagamento. <strong>ItalgiureWeb</strong> è il primo connettore attivo: usa le credenziali Cassa Forense per cercare su Cassazione, Consiglio di Stato, TAR, Corte Costituzionale, Commissioni Tributarie e normativa UE.</p>
<table>
<tr><th>Banca dati</th><th>Stato</th><th>Accesso</th></tr>
<tr><td>ItalgiureWeb</td><td>🟢 Automatizzato</td><td>Credenziali Cassa Forense</td></tr>
<tr><td>De Jure</td><td>🟡 Placeholder</td><td>API key su richiesta</td></tr>
<tr><td>One Legale (WKI)</td><td>🟡 Placeholder</td><td>API key su richiesta</td></tr>
<tr><td>Dike</td><td>🟡 Placeholder</td><td>API key su richiesta</td></tr>
<tr><td>Eurex</td><td>🟡 Placeholder</td><td>API key su richiesta</td></tr>
<tr><td>Juris Data</td><td>🟡 Placeholder</td><td>API key su richiesta</td></tr>
</table>
<div class="note"><strong>Fallback automatico</strong>Se il login automatizzato non dovesse funzionare, il sistema mostra i link rapidi a ItalgiureWeb e SentenzeWeb con la query precompilata. Le credenziali restano sempre nello studio.</div>
