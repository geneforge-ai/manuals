...
Това ръководство описва **съвместните стъпки** между екипа на GeneForge и клиента за превръщане на базов шаблон в пълноценно персонализирано AI клониране.

> **Аудитория:** Ръководители проекти, Customer Success и заинтересовани страни от страна на клиента.  
> **Времева рамка:** Обикновено 5–10 работни дни от старта до доставката, в зависимост от отзивчивостта на клиента и сложността на шаблона.
...
### Сценарий А: Клиентът не може да предостави документи навреме
**Въздействие:** Забавяне във Фаза 2 (Bootstrap Памет).  
**Възстановяване:**
1. GeneForge продължава с **леко досие** (публична информация + интервю).
2. Клиентът предоставя документи в рамките на 5 работни дни; Съветът се преизпълнява.
3. Ако документите никога не пристигнат, проектът се паузира, докато **плащането по етап** не бъде изяснено.

### Сценарий Б: Клиентът отхвърля препоръката на Архитектурния Съвет
**Въздействие:** Връщане към Фаза 3 (ревизиран Съвет).  
**Възстановяване:**
1. Клиентът изпраща писмена обратна връзка с конкретни ограничения.
2. GeneForge изпълнява **втори лек Съвет** в рамките на 24ч.
3. Ако все още нерешено, се планира **човешка escalation среща** с CTO.

### Сценарий В: Прегледът Преди Доставка връща "No-Go"
**Въздействие:** Забавяне на доставката (връщане към Фаза 4).  
**Възстановяване:**
1. GeneForge предоставя **план за коригиране** с точните елементи за поправка.
2. Корекциите се прилагат и се преизпълнява **мини Преглед Преди Доставка**.
3. Типично забавяне: 24–48 часа за дребни елементи; 3–5 дни за сериозно преработване.

### Сценарий Г: Разгръщането се проваля на инфраструктурата на клиента
**Въздействие:** Клонирането не стартира след извличане.  
**Възстановяване:**
1. Клиентът отваря **тикет за поддръжка** с логове на грешки.
2. GeneForge осигурява отдалечено отстраняване на неизправности (споделяне на екран).
3. Ако инфраструктурата е несъвместима, се прилага клауза за **възстановяване на суми или пренасочване на архитектурата** според договора.
