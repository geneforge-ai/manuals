# GeneForge AI Labs — Ръководство за Пътуването на Клиента
...
## Компактна Хронология

| Стъпка | Фаза | Действие GeneForge | Вашето действие | Продължителност |
|--------|------|--------------------|-----------------|-----------------|
| 0 | Договор | Назначава екип, избира шаблон | Посочете контакт, подпишете DPA | Ден 0 |
| 1 | Старт | Провежда стартова среща | Съберете и качете документи | Дни 1–2 |
| 2 | Приемане | Санитаризира и инжектира документи | Одобрете доклада за санитаризация | Дни 2–3 |
| 3 | Съвет | AI Съветът проектира клонирането | Присъствайте на 30-минутен review разговор | Дни 3–5 |
| 4 | Изграждане | Персонализира prompt-ове и UI | Валидирайте терминология и UI | Дни 5–7 |
| 5 | Преглед | Съвет Преди Доставка | Присъствайте на 15-минутен одобрителен разговор | Дни 7–8 |
| 6 | Пакетиране | Създава артефакт `.geneclone` | Проверете checksum и потвърдете | Дни 8–9 |
| 7 | Стартиране | Отдалечена поддръжка | Стартирайте wizard и влезте в експлоатация | Дни 9–10 |
| 8 | Мониторинг | Телеметрия и drift detection | Анкети за удовлетвореност | Постоянно |
...
| Документ | Цел | Приоритет | Препоръчителен Формат |
|----------|-----|-----------|------------------------|
| **Преглед на Компанията** | Мисия, визия, ценности, стратегически приоритети | 🔴 Критично | PDF, Word или Markdown (2–10 страници) |
| **Карта на Процесите** | Основни бизнес процеси и работни потоци | 🔴 Критично | BPMN диаграма, flowchart PNG или списък Markdown |
| **Структура на Екипа** | Организационна диаграма, роли, йерархия на вземане на решения | 🟡 Важно | PDF организационна диаграма, PowerPoint слайд или spreadsheet |
| **Финансова Снимка** | Модел на приходите, цели за растеж, бюджетни ограничения | 🟡 Важно | PDF отчет или Excel (само обобщени данни) |
| **Културни Артефакти** | Вътрешни имейли, документи с ценности, примери за комуникация | 🟢 Желателно | PDF сканирания, експортирани имейли или Word документи |
| **Изисквания за Съответствие** | GDPR, HIPAA, SOX или секторно-специфични регламенти | 🔴 Критично (ако е регламентирано) | PDF сертификати, policy документи или одитни доклади |
| **Бранд Насоки** | Лого, тон на глас, визуална идентичност | 🟡 Важно | PDF brand book, ZIP с активи или линк към style guide |
